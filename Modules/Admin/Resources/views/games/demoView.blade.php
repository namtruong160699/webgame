...
@section('content')
        ...
        <div class="content-viewport">
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-12 equel-grid">
                    <div class="canvas-unity" style="width: 100%;" id="divgame">
                        ...
                        <div class="grid">
                            <div class="grid-body text-gray">
                                <a href="javascript:void(0)"
                                   onclick="clickGame('{{$game->file_game}}','{{$game->name}}')">
                                    <div class="d-flex">
                                        <div class="app-icon">
                            ...
                            <ul class="base-platforms">
                                <li title="iTunes">
                                    <svg viewBox="0 0 512 512" fill="white"
                                         class="badge ios {{$game->operating_system == 1 ? 'active' : ''}}">
                                ...
                                <li title="Google Play">
                                    <svg viewBox="0 0 427 512" fill="white"
                                         class="badge android {{$game->operating_system == 2 ? 'active' : ''}}">
    ...
    <script>
        ...
        function clickGame(file_game = '', gamename = '') {
            $('#divgame').html(' <iframe src="" title="Iframe Game" style="width: 100%;height: 100%;"></iframe>');
            $.ajax({
                url: "{{route('get.demo.view.ajax')}}",
                //async: false,
                dataType: "json",
                data: {file_game: file_game},
                type: "GET",
                success: function (data) {
                    $('#gamename').html(gamename == '' ? "Squid Game" : gamename);
                    $('#divgame').html('<iframe src="filegame/' + data + '/index.html" title="Iframe Game" style="width: 100%;height: 100%;"></iframe>');
                },
                error: function () {
                }
            });
